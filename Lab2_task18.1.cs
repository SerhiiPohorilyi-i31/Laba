public class Plant
{
    ...
    // Віртуальний метод для виведення назви рослини
    public virtual void DisplayInfo()
    {
        Console.WriteLine($"Назва рослини: {Name}, висота: {Height}");
    }

    // Віртуальний метод для опису рослини
    public virtual void Describe()
    {
        Console.WriteLine("Це рослина загального типу.");
    }
}
